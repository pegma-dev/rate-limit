...
`@pegma` scope, one repository per component. This repository is deliberately
dormant until the support desk (its first consumer) pulls it — the project
plan is the current deliverable.
